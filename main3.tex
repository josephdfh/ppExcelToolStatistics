...
\begin{document}
  ...
  %% Note that you should use the \pkg{}, \proglang{} and \code{} commands.
    ...
    \section[intro]{Introduction}
        ...
        \begin{figure}[!tbh]
          \includegraphics[width=400pt, keepaspectratio=true]{CanCorrSheetExplain_png}
        ...
        \end{figure}
        The full correlation matrix including the original dataset and the constructed canonical variates is displayed in range starting at cell \texttt{CanCorr!AY3}, shown as Figure \ref{fig:cancorr full correlation matrix}. This full correlation matrix has only one version as it is invariant to studentization of the input data. 
