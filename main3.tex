...
\begin{document}
  ...
  %% Note that you should use the \pkg{}, \proglang{} and \code{} commands.
    ...
    \section[intro]{Introduction}
        ...
        Rectangles 3 and 7 display the covariance and correlation matrices. These are the starting point of two branches of computation. 
